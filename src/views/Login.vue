      ...
      <el-form :model="loginForm" :rules="loginRules" ref="loginForm" label-width="0px" class="login_Form">
        ...
        <el-form-item prop="verifyCode">
          <div class="verifyCode_box">
            <el-input v-model="loginForm.verifyCode" prefix-icon="el-icon-mobile" class="verifyCode" placeholder="请输入验证码"></el-input>
            <img src="../assets/img/verify.png" class="verify_img">
          </div>
        </el-form-item>
        <el-form-item class="login_btn">
          <el-button type="primary" @click="toregist">去注册</el-button>
